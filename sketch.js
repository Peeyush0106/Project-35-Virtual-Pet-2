...
var dog_norm, dog_hap, dog, database, food_stock, playerCount, playerCount_data, gameState, gameText, resetDogMoodTimer, counter, pet_hungry_text, pet_satis_text, max_pet_satis_time, inputNam, butto, greeting, txt1, txt2 /*, txt3*/, txt4, txt5, txt6, txt7, feed_button, buy_button, start_text, money;
...
function setup() {
    ...
    button = createButton("Play").position(340, 15).style("background-color", "blue").style("color", "white").mousePressed(function () {
        ...
        gameState = "hungry";
        pet_hungry_text = [(inputName.value() + "'s hungry."), ("Press the button above to feed it")];
